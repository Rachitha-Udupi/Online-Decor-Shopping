<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Curtains.aspx.cs" Inherits="curtain" %>
        ...
        <asp:DataList ID="DataList1" runat="server" DataKeyField="item_id" DataSourceID="SqlDataSource1"
            ...
            <ItemTemplate>
                <table>
                    ...
                    <tr>
                        <td style="width: 100px">
                            <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("item_image") %>' Width="410px" Height="324px" /></td>
                    </tr>
                    <tr>
                        <td style="width: 100px">
                            <asp:Label ID="Label4" runat="server" CssClass="input" Text='<%# Eval("item_name") %>' ForeColor="Black"></asp:Label></td>
                    </tr>
                    <tr>
                        <td style="width: 100px">
                            &nbsp;<asp:Label ID="Label1" runat="server" CssClass="input" Text='<%# Eval("price") %>' ForeColor="Black"></asp:Label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 100px">
                            ...
                            <asp:TextBox ID="TextBox1" runat="server" CssClass="input" Text='<%# Eval("qty") %>' Visible="False" ForeColor="#000000"></asp:TextBox><br />
                            <span style="color: #ffffff">Quantity :
                                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnDataBound="DropDownList1_DataBound" OnLoad="DropDownList1_Load" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" CssClass="input" >
                    ...
                    <tr>
                        <td style="width: 100px; height: 26px;">
                            <asp:Button ID="Button1" runat="server" CssClass="button" Text="Add To Cart" OnClick="Button1_Click" CommandArgument='<%#Eval("item_id")%>' CommandName="addtocart" ForeColor="White" style="font-variant: small-caps" Font-Bold="True" /></td>
                    </tr>
                    <tr>
                        <td style="width: 100px; height: 21px">
                            <asp:Button ID="Button2" runat="server" CssClass="button" Text="View Item" CommandName="viewdetail" CommandArgument='<%#Eval("item_id")%>' ForeColor="White" style="font-variant: small-caps" Font-Bold="True" /></td>
                    </tr>
                </table>
            </ItemTemplate>
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="Curtains" Name="category" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp;
