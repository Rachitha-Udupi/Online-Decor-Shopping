        ...
        if (Request.QueryString["utype"] != null)
        {
            if (Request.QueryString["utype"].ToString() == "buyer")
            {
                ...
                { 
                    ...
                    c.cmd.CommandText = "select message,response,date,date1 from help where id='" + Session["cid"].ToString() + "' and utype='buyer' order by date";
                ...
                {
                    Response.Redirect("loginform.aspx?val=login");
                }
            }
            else if (Request.QueryString["utype"].ToString() == "seller")
            {
                ...
                else
                {
                    ...
                    Response.Redirect("seller/sloginform.aspx?val=login");
                }
            }
            else if (Request.QueryString["utype"].ToString() == "logistic")
            {
                ...
                else
                {
                    ...
                    Response.Redirect("log/loginform.aspx?val=login");
                }
            }
        }
        else
