...
public partial class curtain : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //MessageBox.Show(Session["cust_id"].ToString ());
    ...
    //        while (drd.Read())
    //        {
    //            qty = Convert.ToInt32(drd["qty"].ToString());
    //        }
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        //string ino = ((System.Web.UI.WebControls.Label)e.Item.FindControl("Label3")).Text;
        //int q = ((System.Web.UI.WebControls.DropDownList)e.Item.FindControl("DropDownList1"));
        //try
        //{
        //    c = new connect();
        //    int qty;
        //    c.cmd.CommandText = "select qty from item where item_id='" + ino  + "'";
        //    //object obj1 = c.cmd.ExecuteScalar();
        //    //if (obj1 != null)
        //    //   qty  = Convert .ToInt16 (obj1.ToString());
        //    qty =Convert .ToInt16 ( c.cmd.ExecuteScalar());
        //    //if (qty < Convert.ToInt16(qt))
        //    //{
        //    //    MessageBox.Show("Quantity is less in stock");
        //    //}
        //    if (qty<10)
