<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lightsub.aspx.cs" Inherits="lightsub" %>
...
<body bgcolor="#000000">
  ...
  <a href="categorypage.aspx" style="width:130px; color: #000000;"><span>Category</span></a>
                ...
                <table>
                    ...
                    <tr>
                        <td style="width: 100px; height: 21px;">
                            <asp:Label ID="Label2" runat="server" CssClass="input" Text='<%# Eval("description") %>' Visible="False" ForeColor="White"></asp:Label></td>
                    </tr>
                    <tr>
                        <td style="width: 100px">
