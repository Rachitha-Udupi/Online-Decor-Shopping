<%@ Page Language="C#" AutoEventWireup="true" CodeFile="decorativesub.aspx.cs" Inherits="decorativesub" %>
...
<body bgcolor="#000000">
  ...
  <a href="category.aspx" style="width:130px; color: #000000;"><span>Category</span></a>
    ...
    <div>
        ...
        <%--<asp:ImageButton ID="ImageButton1" runat="server" BackColor="White" Height="38px"
            OnClick="ImageButton1_Click" Width="93px" />
        &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:ImageButton ID="ImageButton2" runat="server" BackColor="White" Height="39px"
            OnClick="ImageButton2_Click" Width="93px" />--%><br />
        <br />
