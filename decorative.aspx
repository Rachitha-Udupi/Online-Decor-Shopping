<%@ Page Language="C#" AutoEventWireup="true" CodeFile="decorative.aspx.cs" Inherits="decorative" %>
  ...
  <a href="category.aspx" style="width:130px; color: #000000;"><span>Category</span></a>
    ...
    <div>
        ...
        <asp:DataList ID="DataList1" runat="server" DataKeyField="item_id" DataSourceID="SqlDataSource1"
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="Decorative items" Name="category" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
         </asp:Panel>
       </div> 
