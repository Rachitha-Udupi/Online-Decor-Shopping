...
public partial class Rate : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "msgbox", "<script> message('Plzz buy the product before rating!!!')</script>");
        ...
        else
        {
            ...
            dt.Clear();
            adp.Fill(dt);
            c.cmd.CommandText = "select review,rate from reviews where product_id='" + Session["product_id"].ToString() + "'";
            adp.SelectCommand = c.cmd;
            dt9.Clear();
            adp.Fill(dt9);
             n = dt9.Rows.Count;
            ...
            if (Request.QueryString["action"] != null)
                {
                    c.cmd.CommandText = "select review,rate from reviews where product_id='" + Session["product_id"].ToString() + "' and order_id=" + Convert.ToInt64(Session["order_id"]) + " and cid='" + Session["cid"].ToString() + "'";
                    adp.SelectCommand = c.cmd;
                    dt1.Clear();
                    adp.Fill(dt1);
                    if (dt1.Rows.Count > 0)
            ...
            if (Request.QueryString["action"] != null)
            {
                ...
                if (txtreason.Text != "")
                {
                    if (star1.Checked == true)
                    {
                        ...
                        c.cmd.ExecuteNonQuery();
                        c.cmd.CommandText = "update reviews set rate=1,review=@desc where cid='" + Session["cid"].ToString() + "' and product_id='" + Session["product_id"].ToString() + "'and order_id=" + Convert.ToInt64(Session["order_id"]) + "";
                    ...
                    else if (star2.Checked == true)
                    {
                        ...
                        c.cmd.ExecuteNonQuery();
                        c.cmd.CommandText = "update reviews set rate=2,review=@desc where cid='" + Session["buyer_id"].ToString() + "' and product_id='" + Session["product_id"].ToString() + "'and order_id=" + Convert.ToInt64(Session["order_id"]) + "";
                        c.cmd.Parameters.Clear();
                        c.cmd.Parameters.Add("@desc", SqlDbType.NVarChar).Value = txtreason.Text;
                        c.cmd.ExecuteNonQuery();
                        Response.Redirect("Home.aspx");
                    ...
                    else if (star3.Checked == true)
                    {
                        ...
                        c.cmd.ExecuteNonQuery();
                        c.cmd.CommandText = "update reviews set rate=3,review=@desc where cid='" + Session["cid"].ToString() + "' and product_id='" + Session["product_id"].ToString() + "'and order_id=" + Convert.ToInt64(Session["order_id"]) + "";
                        c.cmd.Parameters.Clear();
                        c.cmd.Parameters.Add("@desc", SqlDbType.NVarChar).Value = txtreason.Text;
                        c.cmd.ExecuteNonQuery();
                        Response.Redirect("Home.aspx");
                    ...
                    else if (star4.Checked == true)
                    {
                        ...
                        c.cmd.ExecuteNonQuery();
                        c.cmd.CommandText = "update reviews set rate=4,review=@desc where cid='" + Session["cid"].ToString() + "' and product_id='" + Session["product_id"].ToString() + "'and order_id=" + Convert.ToInt64(Session["order_id"]) + "";
                        c.cmd.Parameters.Clear();
                        c.cmd.Parameters.Add("@desc", SqlDbType.NVarChar).Value = txtreason.Text;
                        c.cmd.ExecuteNonQuery();
                        Response.Redirect("Home.aspx");
                    ...
                    else if (star5.Checked == true)
                    {
                        ...
                        c.cmd.ExecuteNonQuery();
                        c.cmd.CommandText = "update reviews set rate=5,review=@desc where cid='" + Session["cid"].ToString() + "' and product_id='" + Session["product_id"].ToString() + "'and order_id=" + Convert.ToInt64(Session["order_id"]) + "";
                        c.cmd.Parameters.Clear();
                        c.cmd.Parameters.Add("@desc", SqlDbType.NVarChar).Value = txtreason.Text;
                        c.cmd.ExecuteNonQuery();
                        Response.Redirect("Home.aspx");
            ...
            else
            {
                if (txtreason.Text != "")
                {
                    if (star1.Checked == true)
                    {
                        ...
                        c.cmd.ExecuteNonQuery();
                        c.cmd.CommandText = "insert into reviews(cid,product_id,review,order_id,rate) values('"+Session["cid"].ToString()+"','" + Session["product_id"].ToString() + "',@desc," + Convert.ToInt64(Session["order_id"]) + ",1) ";
                        c.cmd.Parameters.Clear();
                        c.cmd.Parameters.Add("@desc", SqlDbType.NVarChar).Value = txtreason.Text;
                        c.cmd.ExecuteNonQuery();
                        Response.Redirect("Home.aspx");
                    ...
                    else if (star2.Checked == true)
                    {
                        ...
                        c.cmd.ExecuteNonQuery();
                        c.cmd.CommandText = "insert into reviews(cid,product_id,review,order_id,rate) values('" + Session["cid"].ToString() + "','" + Session["product_id"].ToString() + "',@desc," + Convert.ToInt64(Session["order_id"]) + ",2) ";
                        c.cmd.Parameters.Clear();
                        c.cmd.Parameters.Add("@desc", SqlDbType.NVarChar).Value = txtreason.Text;
                        c.cmd.ExecuteNonQuery();
                        Response.Redirect("Home.aspx");
                    ...
                    else if (star3.Checked == true)
                    {
                        ...
                        c.cmd.ExecuteNonQuery();
                        c.cmd.CommandText = "insert into reviews(cid,product_id,review,order_id,rate) values('" + Session["cid"].ToString() + "','" + Session["product_id"].ToString() + "',@desc," + Convert.ToInt64(Session["order_id"]) + ",3) ";
                        c.cmd.Parameters.Clear();
                        c.cmd.Parameters.Add("@desc", SqlDbType.NVarChar).Value = txtreason.Text;
                        c.cmd.ExecuteNonQuery();
                        Response.Redirect("Home.aspx");
                    ...
                    else if (star4.Checked == true)
                    {
                        ...
                        c.cmd.ExecuteNonQuery();
                        c.cmd.CommandText = "insert into reviews(cid,product_id,review,order_id,rate) values('" + Session["cid"].ToString() + "','" + Session["product_id"].ToString() + "',@desc," + Convert.ToInt64(Session["order_id"]) + ",4) ";
                        c.cmd.Parameters.Clear();
                        c.cmd.Parameters.Add("@desc", SqlDbType.NVarChar).Value = txtreason.Text;
                        c.cmd.ExecuteNonQuery();
                        Response.Redirect("Home.aspx");
                    ...
                    else if (star5.Checked == true)
                    {
                        ...
                        c.cmd.ExecuteNonQuery();
                        c.cmd.CommandText = "insert into reviews(cid,product_id,review,order_id,rate) values('" + Session["cid"].ToString() + "','" + Session["product_id"].ToString() + "',@desc," + Convert.ToInt64(Session["order_id"]) + ",5) ";
                        c.cmd.Parameters.Clear();
                        c.cmd.Parameters.Add("@desc", SqlDbType.NVarChar).Value = txtreason.Text;
                        c.cmd.ExecuteNonQuery();
                        Response.Redirect("Home.aspx");
