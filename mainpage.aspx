...
<head runat="server">
    <title>ONLINE DECOR SHOPPING</title>
...
<body bgcolor="buttonface">
  ...
  <div><span style="color: black"></span>
      <asp:Panel ID="Panel1" runat="server" BackImageUrl="~/frontpage.jpg">
      
      <asp:Button ID="Button1" runat="server" Text="Already member?" CssClass="input" style="left: 771px; position: relative; top: 156px" Width="295px" ForeColor="Navy" OnClick="Button1_Click" Font-Bold="True"  />
      <br />
      <br /><asp:Button ID="Button2" runat="server" Text="Sign Up" CssClass="input" Width="295px" ForeColor="Navy" style="left: 875px; position: relative; top: 162px" OnClick="Button2_Click" Font-Bold="True"/>
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      ...
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      <asp:Button ID="Button3" runat="server" CssClass="input" ForeColor="Navy" Style="left: 131px;
          position: relative; top: -14px" Text="SKIP SIGN UP>>>" Width="429px" OnClick="Button3_Click" Font-Bold="True" /><br />
      <br />
      <br />
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
