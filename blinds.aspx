...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blinds.aspx.cs" Inherits="blinds" %>
       ...
       <asp:DataList ID="DataList1" runat="server" DataKeyField="item_id" DataSourceID="SqlDataSource1"
            ...
            <ItemTemplate>
                <table>
                    ...
                    <tr>
                        <td style="width: 100px; height: 309px;">
                            <asp:Image ID="Image1" runat="server" Height="354px" ImageUrl='<%# Eval("item_image") %>'
                                Width="319px" /></td>
                    </tr>
                    <tr>
                        <td style="width: 100px">
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="Blinds" Name="category" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
