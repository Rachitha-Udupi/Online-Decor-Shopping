<%@ Page Language="C#" AutoEventWireup="true" CodeFile="curtainsub.aspx.cs" Inherits="curtainsub" %>
...
<body bgcolor="#000000">
    <form id="form1" runat="server">
     <h1 class="glow">
        ...
        <div class="header">
            <img src="logo.jpg" alt="logo" height="20" style="left: 154px; position: relative; top: -145px" />
    </div>    
  ...
  <a href="category.aspx" style="width:130px; color: #000000;"><span>Category</span></a>
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="item_id" DataSourceID="SqlDataSource1"
             RepeatColumns="3" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand" ForeColor="#FFFFFF"  >
            <ItemTemplate>
                <table>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 100px; height: 26px;">
                            <asp:Button ID="Button1" runat="server" CssClass="button" Text="Add To Cart" CommandArgument='<%#Eval("item_id")%>' CommandName="addtocart" ForeColor="White" OnClick="Button1_Click" /></td>
                    </tr>
                    <tr>
                        <td style="width: 100px; height: 21px">
                            <asp:Button ID="Button2" runat="server" CssClass="button" Text="View Item" CommandName="viewdetail" CommandArgument='<%#Eval("item_id")%>' ForeColor="White" /></td>
                    </tr>
                </table>
            </ItemTemplate>
        </asp:DataList>
