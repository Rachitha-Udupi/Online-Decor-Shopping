...
public partial class checkouts : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        c = new connect();
        int count1, count2;
        c.cmd.CommandText = "select max(order_id) from orderdetail ";
        ...
        for (int i = 0; i < ds.Tables["cart"].Rows.Count; i++)
        {
            ...
            c.cmd.CommandText = "update item set qty=qty-@qt where item_id='" + ds.Tables["cart"].Rows[i].ItemArray[0] + "'";
            c.cmd.Parameters.Add("@qt", SqlDbType.Int).Value = ds.Tables["cart"].Rows[i].ItemArray[5];
            c.cmd.ExecuteNonQuery();
        }
        // c.cmd.ExecuteNonQuery();
        c.cmd.CommandText = "delete from cart where cust_id='" + Session["cust_id"] + "'";
        c.cmd.ExecuteNonQuery();
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        SqlDataReader myreader = null;
        c.cmd.CommandText = "select  email from customer where cust_id='" + Session["cust_id"] + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //while (myreader2.Read())
        //{
        //    Label29.Text = (myreader2["name"].ToString());
        //    Label30.Text = (myreader2["cardno"].ToString());
        //    Label31.Text = (myreader2["cvv"].ToString());
        //    Label32.Text = (myreader2["month"].ToString());
        //    Label33.Text = (myreader2["year"].ToString());
        ...
        ////{
        ////    MessageBox.Show("Enter expiry month and year");
        ////}
        ////else if (DropDownList1.SelectedIndex < 1)
        ////{
        ////    MessageBox.Show("Enter expiry month");
        ////}
        ////else if (DropDownList2.SelectedIndex < 1)
        ////{
        ////    MessageBox.Show("Enter expiry year");
        ////}
        //else
        //{
        //    if (TextBox11.Text == Label29.Text && TextBox12.Text == Label30.Text && TextBox13.Text == Label31.Text)
        ...
        //        int t, b;
        //        t = Convert.ToInt16(Label17.Text);
        //        b = Convert.ToInt16(Label34.Text);
        //        if (t > b)
        //        {
        //            MessageBox.Show("Insufficient money!!");
        //        }
    ...
    //        }
    //    }
    //    else if (TextBox11.Text != Label29.Text && Convert.ToInt16(TextBox12.Text) == Convert.ToInt16(Label30.Text) && Convert.ToInt16 (TextBox13.Text) == Convert.ToInt16(Label31.Text))
    //    { MessageBox.Show("No card available in this name!!"); }
    //    else if (TextBox11.Text == Label29.Text && Convert.ToInt16 (TextBox12.Text) != Convert.ToInt16 (Label30.Text) && Convert.ToInt16 (TextBox13.Text) == Convert.ToInt16 (Label31.Text))
    //    { MessageBox.Show("Check card no!!"); }
    //    else if (TextBox11.Text == Label29.Text && Convert.ToInt16 (TextBox12.Text)==Convert .ToInt16 ( Label30.Text) && Convert.ToInt16 (TextBox13.Text)!= Convert.ToInt16 (Label31.Text))
